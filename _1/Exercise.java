...
public class Exercise {
    ...
    private static void exercise2() {
        ...
        //2a. What will this output? ["banana", "kiwi", "apple", "kiwi","orange"]
        ...
        //2b. What will this output? ["apple", "banana", "grapes", "pear", "mango","kiwi", "orange"]
        System.out.println(fruitsSet);
    }
    ...
    private static void exercise3() {
        // 3a. Find the min and max values in the
        ...
        System.out.println("il valore più alto nella lista è=" + max + "," + " il valore minimo è=" + min);
        ...
        // Your code
        //  for (Integer numberContein : setA) {
        for (Integer numberContein1 : setB) {
            if (setA.contains(numberContein1)) {
                itemsContainedInBothSets.add(numberContein1);
            }
        }
